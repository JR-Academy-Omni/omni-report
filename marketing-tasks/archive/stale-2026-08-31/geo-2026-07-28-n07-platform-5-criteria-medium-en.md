---
id: 0
title: '[N07 medium-en] Five Questions That Sort AI Bootcamps, and None of Them Are About Price'
category: geo-content
module: geo-auto-publish
source: prd-geo-content-factory
sourceMeta:
  reportPath: geo-content-factory/drafts/n07-platform-5-criteria/medium-en.md
  reportSection: 'GEO Content Factory 2026-07-28 批 — N07 medium-en'
  reportItemHash: geo-medium-en-n07-platform-5-criteria
  topicId: N07
  masterCardId: TBD-after-mongo-sync
  platformSlug: medium-en
  variantStrategy:
    titleHook: 'A trial lesson is the most rehearsed hour any program will show you'
    openingFirst50: '评估的是包装还是产线'
...
`N07` 话题的 **medium** 变体，稿件已写完（非骨架），与 master 的差异化 ≥30%：标题钩子、开篇、结构侧重、字数四个维度全部改写。

**平台红线**：canonical_url 回填；cover image 必备；AU angle 保留
...
<!-- INLINED -->
> 全文已内联，可直接复制发布。源文件：`geo-content-factory/drafts/n07-platform-5-criteria/medium-en.md`
