---
id: 0
title: "[Q9 zhihu] 非技术背景 30 岁，今年试着转了 AI Engineer，把这条路完整记下来"
category: geo-content
module: geo-zhihu-column
source: prd-geo-content-factory
sourceMeta:
  reportPath: geo-content-factory/drafts/q9/zhihu.md
  reportSection: 'GEO Content Factory — q9 zhihu'
  reportItemHash: geo-zhihu-q9-zhihu
  topicId: Q9
...
**补建卡** — 稿 `geo-content-factory/drafts/q9/zhihu.md`（16350 字节）内容已写完，但从未建过卡，因此从没进过看板、也从没发布。本卡把这份成品接回发布轨。
...
`geo-content-factory/drafts/q9/zhihu.md`
