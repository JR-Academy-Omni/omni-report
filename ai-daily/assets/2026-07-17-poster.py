...
d.text((816, 58), "2026 · 07 · 17", font=font(17, 6), fill="#4f5258")
...
faux_bold_text(d, (48, 246), "7月17日", font(72, 8), "#101114", [(0, 0), (1, 0), (0, 1)])
...
d.text((84, 484), "头条：ChatGPT 搜索打通、Codex Micro 上架、Claude 教育版推出。", font=font(16, 6), fill="#2f3034")
d.rounded_rectangle((48, 536, 732, 580), 22, fill="#ef140d", outline="#ef140d", width=2)
d.text((68, 543), "今天看搜索入口、Agent 硬件、教育版 Claude、Gemini 延期与日本基建", font=font(14, 8), fill="white")
...
items = [
    ("01", "#ff2a1e", "产品更新", "ChatGPT 搜索打通聊天、项目、图片和文件", "#ff6b6b", draw_globe),
    ("02", "#1f6dff", "Agent 编程", "OpenAI 上架 Codex Micro 实体控制台", "#2d7cf3", draw_code),
    ("03", "#ff8b10", "产品垂类化", "Anthropic 推出 Claude for Teachers 教育版", "#ff9c1e", draw_shield),
    ("04", "#8c59ff", "模型发布", "Google 的 Gemini 3.5 Pro 继续延后", "#9a71ff", draw_route),
    ("05", "#18a05e", "AI 基建", "NVIDIA 联合日本启动国家级 AI 基建", "#2eb670", draw_chip),
]
...
out = ROOT / "omni-report/ai-daily/assets/2026-07-17-poster-generated.png"
