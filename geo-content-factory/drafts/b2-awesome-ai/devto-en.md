...
I'm aware "we use it in our curriculum" is a phrase with a commercial fingerprint on it, so, disclosure: I'm part of the founding team at [JR Academy](https://jiangren.com.au/learn/ai-engineer), an AI engineering bootcamp in Sydney. That's exactly where the use-driven filter comes from — four years of watching which free resources 100+ career-changers actually finished, and which ones they bounced off. The list links only to free resources. If you find an entry where the "why we use it" line is weak, that's a legitimate issue to open.
