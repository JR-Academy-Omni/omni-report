---
slug: mcp-getting-started-2026
title: 写第一个 MCP Server：从一个学员晚上 11 点的 Slack 消息说起
type: ai-engineer
publishedDate: 2026-05-12
description: MCP（Model Context Protocol）真正的入门坑不在协议本身，而在 stdio 通道污染、Claude Desktop 配置路径、5 个官方 server 的安全设置。这篇基于一次 11 点学员 Slack 求助实录拆开讲。
keywords: MCP, Model Context Protocol, Anthropic, Claude Desktop, FastMCP, AI Engineer, 澳洲求职, JR Academy
author: JR Academy / Lightman
ogImage: /blog/mcp-getting-started-2026/cover.png
---
